...
// static data members
static private double MinBalance = 50;
...
{
	CurBalance = this.ChargeFee(CurBalance - debitAmount);
	return CurBalance;
}

public double CreditTransaction(double creditAmount)
{
	CurBalance = this.ChargeFee(CurBalance + creditAmount);
	return CurBalance;
}

private double ChargeFee(double balance)
{
